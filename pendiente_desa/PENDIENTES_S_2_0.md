...
El 7 de agosto de 2026 se verificó directamente en `USER_SOURCE` que `PKG_GT_ORG_UNIDAD` valida correctamente `ACTIVO` con `S/N`. Durante una intervención de mantenimiento el package body quedó temporalmente truncado e `INVALID`, pero fue restaurado desde la copia completa versionada y terminó nuevamente `VALID`. El incidente está documentado en `docs/INCIDENTE_PKG_GT_ORG_UNIDAD_2026-08-07.md`.
